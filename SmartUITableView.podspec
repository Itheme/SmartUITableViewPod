...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   UITableView that doesn't crash on wrong updates (for iOS)
...
updates in the storyboard or xib and don't forget to look at the log
  ...
  s.homepage     = "https://github.com/Itheme/SmartUITableViewPod"
  ...
  s.source       = { :git => "https://github.com/Itheme/SmartUITableViewPod.git", :tag => "0.2.6" }
